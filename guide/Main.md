...
顶部右上角是菜单，点击按钮可以打开对应的窗口  
顶部左侧是当前使用的账户，点击可以打开账户设置窗口  
下方是游戏实例和游戏实例分组，所有游戏实例都在这里  
...
- 从头新建实例  
![](pic2.png)  
从头新建实例很简单，只需要填写实例名字，选择版本等信息，最后点击右下角的`完成`按键即可添加  
可以从在线的整合包来添加实例，点击`搜索整合包`可以打开此窗口  
可以下载云同步实例，点击`下载云同步实例`可以选择实例  
可以下载服务器实例，点击`下载服务器实例`可以填入网址开始下载  
![](pic70.png)  
![](pic71.png)  
...
[AXAML](https://docs.avaloniaui.net/docs/next/basics/user-interface/introduction-to-xaml)  
[UI控件](https://docs.avaloniaui.net/docs/next/basics/user-interface/controls/builtin-controls)
