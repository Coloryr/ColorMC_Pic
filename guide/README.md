...
- 自定义主界面 启用自定义界面代码，[教程](https://github.com/Coloryr/ColorMC/blob/master/CustomGui.md)
...
在主界面右击游戏实例，选择`调整手柄`可以调整设置

**开启了此功能后，会使用`ColorMCASM`，仅支持JAVA8及以上的游戏版本**
